...
func (su *BTreeSuite) height(b *bTree[int, int]) int {
...
func (su *BTreeSuite) descendOffset(height int) []int {
	n := 0
...
func (su *BTreeSuite) descendTab(height int) []int {
	sli := make([]int, 0, height)
...
func (su *BTreeSuite) pow(n, x int) int {
	result := n
	if x <= 0 {
		return 1
	}
